...
async def local_model_check(text: str):
    ...
    prompt = f"""你是内容安全审核员。判断以下内容是否安全：
        ...
        【审查范围】：
        1. 涉黄内容：包含色情、低俗、露骨的性描写与暗示；
        2. 涉政内容：包含敏感政治人物、政治事件、反党反政府的言论；
        3. 暴力内容：包含血腥、暴力、恐怖、自残、自杀的描写与暗示；
        4. 过激内容：包含辱骂、诽谤、人身攻击、地域黑的言论；
        5. 消极内容：包含传播负面、极端价值观，诱导他人产生消极情绪的言论；
        6. 其他违规内容：包含毒品、赌博、邪教等违法违规内容的言论。
